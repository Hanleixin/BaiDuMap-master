...
import com.example.mylocation.overly.BusLineOverlay;

import java.util.ArrayList;
import java.util.List;

public class BusLineSearchDemo extends AppCompatActivity implements BaiduMap.OnMapClickListener, OnGetPoiSearchResultListener, OnGetBusLineSearchResultListener {
